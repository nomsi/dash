...
import GuildAction from '@spectacles/cache/typings/actions/Guild';
...
export class RedisClient extends EventEmitter {
    ...
    public constructor() {
        ...
        this.redis.on('pmessage', (pattern: string, channel: string, payload: any[]): void => {
            try {
    ...
    public async saveGuild(guild: Guild): Promise<void> {
        try {
            ...
            this.logger.log('redis', `Could'nt save guild: ${e.message}`);
        }
    }
